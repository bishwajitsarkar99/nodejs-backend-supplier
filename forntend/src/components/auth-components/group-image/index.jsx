...
export const GroupImage = () => {
    return (
        <SubSection className={twMerge(
            "w-full h-full",
            "bg-[linear-gradient(45deg,lightgray_5px,transparent_2px),linear-gradient(90deg,#80808010_5px,transparent_2px)]",
            "bg-size-[15px_15px] mask-image-[radial-gradient(ellipse_130%_130%_at_50%_50%,#000_80%,transparent_100%)] bg-blend-lighten",
            "animate-[rotatedGrid_20s_linear_infinite]"
        )}>
            <Div className={
                twMerge("pt-10 tracking-wide drop-shadow-[2px_2px_0_rgba(0,0,0,0.2)] bg-linear-to-r from-emerald-800 to-emerald-700 text-transparent bg-clip-text")
            }>
                <Div className="w-full p-5 flex justify-around items-center">
                    <Div className="chart-svg">
                        <svg width={twMerge("100px")} height={twMerge("100px")} textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 512 493.46">
                            <g fillRule="nonzero">
                                <path fill={twMerge("darkgreen")} d="M103.74 355.45v47.06h59.3v-47.06h-59.3zm317.89-135.52v182.58h59.3V219.93h-59.3zm-105.95 51.91v130.67h59.26V271.84h-59.26zm-105.95 34.08v96.59h59.26v-96.59h-59.26z" />
                                <path fill={twMerge("orange")} d="M51.99 87.96v353.51h450.06v51.99H26.02C11.66 493.46 0 481.81 0 467.45V87.96h51.99zm417.83-14.19l4.31 33.78c1.33 10.41 10.83 17.76 21.25 16.47 10.41-1.32 17.76-10.83 16.47-21.24l-10.99-85.57c-.58-6.01-4.03-11.66-9.67-14.81-5.15-2.86-11-3.07-16.1-1.12l-82.41 31.74c-9.79 3.78-14.65 14.78-10.87 24.57 3.77 9.79 14.77 14.65 24.56 10.87l28.14-10.83c-30.84 41.83-67.77 76.77-107.64 103.99-57.43 39.21-120.76 62.24-180.55 66.56-10.5.74-18.38 9.83-17.64 20.33.75 10.5 9.84 18.38 20.34 17.63 66.35-4.68 136.31-30 199.3-73.03 45.31-30.91 87.1-71.08 121.5-119.34z" />
                            </g>
                        </svg>
                    </Div>
                    <Div className="text-sm md:text-sm lg:text-5xl xl:text-5xl h-20 font-extrabold">
                        <Span className="">Supplier</Span>
                        <Span className="text-sm md:text-sm lg:text-lg xl:text-lg italic font-extrabold text-indigo-500 text-shadow-amber-500">Management</Span>
                    </Div>
                    <Div className="supplier-svg">
                        <svg width={twMerge("100px")} height={twMerge("100px")} fill={twMerge("darkgreen")} x="0px" y="0px" viewBox="0 0 122.88 109.73" xmlSpace="preserve">
                            <g>
                ...
                <Div className="supp-img flex justify-center items-center">
                    <Image className="size-72" src="/supplier_png.png" alt="supplier_imge" />
                </Div>
            </Div>
        </SubSection>
    )
